...
&  \text{ day $j$ in week $w$, for $i \in \mathbb{P},j \in \mathbb{D}, t \in \mathbb{T}, w \in \mathbb{W}$.} 
\end{flalign*}
...
&  \text{ shift length $k$ on day $j$ in week $w$, for $i \in \mathbb{P},t \in \mathbb{T},k \in \mathbb{K},j \in \mathbb{D}, w \in \mathbb{W}$.} 
\end{flalign*}

Discussion of weekend days worked patterns

\begin{flalign*}
\mathbb{X}(i,t)& = \text{set of shift length indices allowed for tour type $i$, for $i \in \mathbb{T}$}
\end{flalign*}
