...
\nipar So, each period in the planning cycle is defined by a tuple $(i,d,w) \in B$ where $B = \mathbb{P} \times \mathbb{D} \times \mathbb{W}$.
...
\begin{flalign*}
n_H& = \text{number of different shift lengths} \\
\mathbb{H}& = \{1,2,\ldots n_T\} \\
h_k& = \text{$k$'th shift length in periods, for $k \in \mathbb{H}$}
\end{flalign*}
